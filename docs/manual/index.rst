...
The included widgets are really just examples of what can be done with Urwid.
It may be helpful to think of Urwid as a console widget construction set rather
than a finished UI library like GTK or Qt. :ref:`Widget methods
<widget-methods>` describes the widget interface and :ref:`widget layout
